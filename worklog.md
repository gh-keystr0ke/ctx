...
Not yet done this session: re-indexing this repository's own graph at a clean commit (working tree has uncommitted changes; committing was not requested) and the external large-repository validation the user said they will connect separately.
